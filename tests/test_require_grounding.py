...
Cherry-picked from upstream PR #327 (Fixes #209).
Verifies that _filter_ungrounded_extractions correctly filters
extractions without valid char_interval positions.
"""
